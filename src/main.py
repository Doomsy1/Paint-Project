...
from music_player import initialize_music, music_player
from sliders import *
from stamp import initialize_stamps, stamp_manager
from tools import draw_tools, tool_manager, tool_change
from undo_redo import undo_manager
